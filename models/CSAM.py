...
class BottleneckTransformer_CSAM(nn.Module):

    def __init__(self, c1, c2, stride=1, heads=4, mhsa=True, resolution=None, expansion=1):
        super(BottleneckTransformer_CSAM, self).__init__()
        c_ = int(c2 * expansion)
...
class CSAM(nn.Module):
    ...
    def __init__(self, c1, c2, n=1, e=0.5, e2=1, w=20, h=20):
        ...
        self.m = nn.Sequential(
            *[BottleneckTransformer_CSAM(c_, c_, stride=1, heads=4, mhsa=True, resolution=(w, h), expansion=e2) for _ in
              range(n)])
